...
public class OfficesController {
    ...
    public OfficesController(OfficeService officeService, BookingService bookingService,
         OfficeItemService officeItemService, OfficeOfferService officeOfferService){

        this.officeService = officeService;
        this.bookingService = bookingService;
        this.officeItemService = officeItemService;
        this.officeOfferService = officeOfferService;
    }
